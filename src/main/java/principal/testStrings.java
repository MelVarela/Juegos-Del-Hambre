...
public static void main(String[] args) {
        ...
        Evento test4 = new Evento('T', 1, 'O', "\np1(+El@-La#=Elle$) p1(+tonto@-tonta#=tonte$) de &p1s es imbecil de cojones.");
        Evento test5 = new Evento('T', 1, 1, 0, 'O', "\n&p1n se va de paseo a a1(+el@-la#) &a1s.");
        Evento test6 = new Evento('T', 2, 'O', "\n&p1n saluda a &p2n. &p2n le responde a &p1s: 'Eres p1(+tonto@-tonta#=tonte$)'.");
        Evento test7 = new Evento('T', 1, 'O', "\np1(+El@-La#=Elle$) p1(+tonto@-tonta#=tonte$) de &p1s es imbecil de cojones, pero de p2(+el@-la#=elle$) imbecil de &p2s ni hablamos.");
        Evento test8 = new Evento('T', 1, 0, 1, 'O', "\n&p1n se corta sin querer con o1(+un@-una#) &o1s");
